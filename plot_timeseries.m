...
if numel(ni)>0
   disp(' ')
   disp(['From a total of ' num2str(numel(f)) ' CTD reference profiles in the ' basin_name ' basin (from '...
       ' year ' num2str(year/10000000000) ' on), a total of ' num2str(numel(ni)) ...
       ' are NaN for the selected presure level  (' num2str(preslevel) ')'])
end
