...
title({['WMO ' num2str(data.wmo)]; 'Prof. modes: red - available only in R or A mode';...
...
title({['WMO ' num2str(data.wmo) ]; 'Prof. availability with selected flags: red - only in R or A mode';...
