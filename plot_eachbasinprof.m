...
if isempty(gs)==0
    ...
    plot_timeseries(preslevel,year,gs_int,floatdata)
...
if isempty(ip)==0
    ...
    plot_timeseries(preslevel,year,ip_int,floatdata)
...
if isempty(lb)==0
    ...
    plot_timeseries(preslevel,year,lb_int,floatdata)
...
if isempty(nb)==0
    ...
    plot_timeseries(preslevel,year,nb_int,floatdata)
